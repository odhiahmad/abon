...
class RiwayatIzin extends Component {
  ...
  render() {
    ...
    if (this.state.isError) {
      return <ErrorState refresh={this._onRefresh} />;
    }
    return (
      <SafeAreaView style={styles.container}>
        ...
        <Header
          ...
          leftComponent={
            ...
            >
              <Icon size={20} name="arrow-back" color="#fff" />
            </TouchableOpacity>
          }
          centerComponent={{
            text: "Riwayat Izin",
        ...
        <ScrollView style={styles.wrapper}>
          <ListItem
            style={{ marginHorizontal: 5, marginBottom: 5, marginTop: 5 }}
            bottomDivider
