...
import { 
  ...
  Text,Dimensions,
  StyleSheet,
  TouchableOpacity, AsyncStorage, ActivityIndicator, ScrollView
} from "react-native";
...
class TakePhoto extends Component {
  ...
  snap = async () => {
    if (this.camera) {
      ...
      this.setState  ({loading : true, uri:resizedPhoto.uri })
      ...
      let details = {
        nip: token,
        image_tag: '-',
        image_data: {uri: localUri, name: filename, type},
      ...
      console.log("ddddd " +   this.state.uri)
      ...
      return (
        <ScrollView style={{flex:1}}>
          <View style={{ flex: 1, justifyContent:'center', alignItems:'center' }}>
            <View style={{width: 450, height: 500}}>
              <Camera 
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Icon name="refresh-cw" size={30} style={{color:'#00AEEF', marginLeft:10, marginTop:10}} />
                  </TouchableOpacity>
                </View>
              </Camera>
            </View>
